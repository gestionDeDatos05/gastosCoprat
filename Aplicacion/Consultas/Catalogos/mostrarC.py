...
def tablaProyecto(request):
    ...
    data = tblAltaProyecto.objects.all().values("ID", "Folio","IDEstatus_id", "IDEstatus_id__Descripcion","IDCliente_id", "IDCliente_id__Nombre", "Proyecto", "Descripcion", "FechaInicio", "Fechafinal", "Presupuesto")
